...
public class CharMove : MonoBehaviour
{
	...
	float stationaryTurnSpeed = 720; 
	float movingTurnSpeed = 1440;
	...
	{ 
		...
		animator.SetFloat ("Forward", forwardAmount, 0.5f, Time.deltaTime);
		animator.SetFloat ("Turn", turnAmount, 0.5f, Time.deltaTime);*/
	}
